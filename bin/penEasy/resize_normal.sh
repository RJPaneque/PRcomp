...
sed -i "/SUBSECTION FOR PARTICLE POSITION/{n;s/.*/ $midxy  $midxy  $midz                COORDINATES (cm) OF BOX CENTER/}" penEasy/pen??_spc.in penEasy/pen??_nuc.in
echo \"penEasy/pen??_spc.in\" and \"penEasy/pen??_nuc.in\" coordinates of box center modified to \($midxy, $midxy, $midz\)
